...
public class Room {
    ...
    private int integralYesterday; // 昨天的总积分（今天 = integral - integYes）
    private int yesterdayIntegral; // 昨天增加的积分
    private int level; // 房间等级
    private boolean official; // 是否是官方的房间（有特权哦）
    private Date createTime;
    private boolean deleted;

    public Room(Long userId, String roomName, String passwordHash, String desc) {
